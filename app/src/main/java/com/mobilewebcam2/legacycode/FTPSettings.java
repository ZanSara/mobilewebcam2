...
//***        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        getPreferenceManager().setSharedPreferencesName(com.mobilewebcam2.legacycode.MobileWebCam2.SHARED_PREFS_NAME);
	...
	protected void onResume()
	{
		...
		com.mobilewebcam2.legacycode.MobileWebCam2.gInSettings = true;
	}    
    ...
    public void onPause()
    {
		...
		com.mobilewebcam2.legacycode.MobileWebCam2.gInSettings = false;
    }    
};