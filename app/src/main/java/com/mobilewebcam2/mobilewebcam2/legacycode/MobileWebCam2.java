	...
	implements SharedPreferences.OnSharedPreferenceChangeListener
{
	...
	public static String GetLog(Context c, SharedPreferences prefs, PhotoSettings settings)
	{
		...
		if(settings.mMode == Mode.MANUAL)
			log += "Pictures: " + com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.gPictureCounter + "    Uploading: " + com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.gUploadingCount + "   Manual Mode active" + "\r\n";
		else
			log += "Pictures: " + com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.gPictureCounter + "    Uploading: " + com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.gUploadingCount + "\r\n";
		...
		if(settings.mBroadcastReceiver.length() > 0)
			log += "\r\nCustom Reiver: " + settings.mBroadcastReceiver + " " + com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.gCustomReceiverActive;
		if(!settings.mNightAutoBrightness || !settings.IsNight())
		...
		int cnt = 0;
		int i = com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.gCurLogInfos;
		while(cnt < com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.gLogInfos.length)
		{
			if(com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.gLogInfos[i] != null)
				log += com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.gLogInfos[i] + "\r\n";
			i++;
			if(i >= com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.gLogInfos.length)
				i = 0;
			cnt++;
		}
		...
		cnt = 0;
		i = com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.gCurLogMessage;
		while(cnt < com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.gLogMessages.length)
		{
			if(com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.gLogMessages[i] != null)
				log += com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.gLogMessages[i] + "\r\n";
			i++;
			if(i >= com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.gLogMessages.length)
				i = 0;
			cnt++;
		}
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        switch (item.getItemId())
        {
	        ...
	        case MENU_SET_FRONT_BACK:
	        	...
	        	HoneyCombFunctions.invalidateOptionsMenu(com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.this);
...
/*		            TextView text = new TextView(this); 
		            ...
		            builder.setPositiveButton("OK", new DialogInterface.OnClickListener()
		            {
		                ...
		                {
							Toast.makeText(com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.this, "Zoom " + mSettings.mZoom + "%", Toast.LENGTH_SHORT).show();
		                }
		            }).show();
		        }	
	        	return true;
	        ...
	        case MENU_SET_EXPOSURE:
		        {
		            ...
		            builder.setPositiveButton("OK", new DialogInterface.OnClickListener()
		            {
		                public void onClick(DialogInterface dialog, int item)
		                {
							Toast.makeText(com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.this, "Exposure Compensation " + mSettings.mExposureCompensation, Toast.LENGTH_SHORT).show();
		                }
		            }).show();
		        }	
	        	return true;
	        ...
	        case MENU_SET_WHITEBALANCE:
	        {
	            ...
	            builder.setItems(items, new DialogInterface.OnClickListener()
	            {
	                public void onClick(DialogInterface dialog, int item)
	                {
						...
						Toast.makeText(com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.this, mSettings.mWhiteBalance, Toast.LENGTH_SHORT).show();
	        ...
	        case MENU_SET_SCENEMODE:
	        {
	            ...
	            builder.setItems(items, new DialogInterface.OnClickListener()
	            {
	                public void onClick(DialogInterface dialog, int item)
	                {
						...
						Toast.makeText(com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.this, mSettings.mSceneMode, Toast.LENGTH_SHORT).show();
	        	...
	        	if(menuColorEffects != null)
	        	{
		            ...
		            builder.setItems(items, new DialogInterface.OnClickListener()
		            {
		                public void onClick(DialogInterface dialog, int item)
		                {
							...
							Toast.makeText(com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.this, mSettings.mColorEffect, Toast.LENGTH_SHORT).show();
	        ...
	        case MENU_SET_ON_OFFLINE:
	        	if(mSettings.mMobileWebCamEnabled)
	        	{
					...
					PhotoAlarmReceiver.StopNotification(com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.this);
				}
	        	else
	        	{
	        ...
	        case MENU_CONFIGURE_NIGHT:
				...
				Toast.makeText(com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.this,
            ...
            case MENU_SHUTDOWN:
            	MobileWebCamHttpService.stop(com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.this);
            	ControlReceiver.Stop(com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.this, mPrefs);
            	finish();
            	return true;
        }
    ...
    {
        mPrefs = getSharedPreferences(com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.SHARED_PREFS_NAME, 0);
...
/*        try
        ...
        b.setOnClickListener(new OnClickListener()
        	{
 			...
 			{
 				com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.this.openOptionsMenu();
 			}
 		});        
		...
		if(iptext != null)
		{
		    if(mPrefs.getBoolean("server_enabled", true))
		    {
				...
				String myIP = RemoteControlSettings.getIpAddress(com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.this, true);
				if(myIP != null)
        ...
        MobileWebCamHttpService.start(com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.this);
    }
    ...
    public void onResume()
    {
    	...
    	com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.gLastMotionKeepAliveTime = System.currentTimeMillis();
    }
	...
	protected void onNewIntent(Intent intent)
	 {
    	...
    	if(extras != null)
		{
    		...
    		if(command != null)
    		{
				...
				{
					Toast.makeText(com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.this, "start command received", Toast.LENGTH_SHORT).show();
				...
				{
					Toast.makeText(com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.this, "stop command received", Toast.LENGTH_SHORT).show();
				...
				{
					Toast.makeText(com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.this, "refresh command received", Toast.LENGTH_SHORT).show();
				...
				{
					Toast.makeText(com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.this, "photo command received", Toast.LENGTH_SHORT).show();
...
// why?					mHandler.postDelayed(new Runnable() { public void run() { finish(); } }, 2000);
    ...
    public void onSharedPreferenceChanged(SharedPreferences prefs, String key)
	{
    	...
    	if(key == null || key.equals("cam_broadcast_activation"))
    	{
    		...
    		{
    			if(!com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.gCustomReceiverActive)
    				CustomReceiverService.start(com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.this);
    		}
    		else if(com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.gCustomReceiverActive)
    		{
    			CustomReceiverService.stop(com.mobilewebcam2.mobilewebcam2.legacycode.MobileWebCam2.this);
    		}
    	}
